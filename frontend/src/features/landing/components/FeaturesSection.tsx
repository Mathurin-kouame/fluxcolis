    ...
    return (
        <section className="max-w-7xl mx-auto px-6 pb-28">
            <div className=" text-center max-w-3xl mx-auto mb-16">
                <span className="text-blue-600 semibold uppercase tracking-widest text-sm font-bold">Fonctionnalités</span>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {FEATURES.map((feature) => {
                    ...
                    return (
                        <div key={feature.title} className="bg-white border border-slate-200 rounded-3xl p-4 hover:-translate-y-1 duration-300">
